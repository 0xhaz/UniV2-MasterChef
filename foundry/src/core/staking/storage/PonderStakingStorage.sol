...
abstract contract PonderStakingStorage {
    ...
    /// @dev Has exlusive access to privileged operations
    ...
    /// @dev Scaled by FEE_PRECISION for accurate calculations
    ...
    /// @dev Updared when fees are distributed and claimed
