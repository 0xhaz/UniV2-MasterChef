...
/**
 * @title IPonderToken
 * @notice Interface for the Ponder protocol's token functionality
 * @dev Defines core token oeprations, events, and view functions
...
interface IPonderToken {
    ...
    /// @param minter_ New address authorized to mint tokens
    ...
    /// @notice Intitiates ownership transfer process
    ...
    /// @notice Maxmium token supply cap
