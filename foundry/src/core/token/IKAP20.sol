 ...
 * @dev Extends the ERC20 standard with additional function for KYC compliance and admin control
 */
interface IKAP20 {
    /// @notice Admin function to set an allowance no behalf of an owner
    ...
    event KYCBitkubChainSet(
        address indexed caller, address indexed oldAddress, address indexed newAddress
    );
